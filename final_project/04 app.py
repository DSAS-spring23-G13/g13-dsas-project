...
bike_status_df = (
    spark
    .read.format("delta").load(GROUP_DATA_PATH + "streaming/bike_status/output")
    .filter(F.col("station_id") == "daefc84c-1b16-4220-8e1f-10ea4866fdc7").sort("last_reported")
    )
# display(bike_station_df.(1))
display(
